class StoryMethods:
    ...
    def cover_ai(msg,client):
        response_cover = client.images.generate(
            model="dall-e-3",
            prompt=f"{msg} in ghibli style",
            size="1024x1024",
            quality="standard",
            n=1,
        )

        image_url = response_cover.data[0].url
    ...
    def design_ai(msg,client):
        design_response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "role": "system",
                "content": """"Based on the story given,
                            You will design a detailed image prompt for the cover image of this story.
                            The image prompt should include theme of the story with relevant color suitable for children book.
